...
#line default
            ...
            var success = AddListener(response);
            if (success)
            {
                try
                {
        ...
        /// <returns>True if the response could be added, false if it was already added before.</returns>
        public bool AddListener(Action<T> response)
        {
            return InternalAddResponse(response);
        }

        public sealed override bool AddListener(Action response)
        {
        ...
        public sealed override void RemoveListener(Action response)
        {
    ...
    public abstract class SodaEventBase
    {
        ...
        public abstract bool AddListener(Action response);
        public abstract void RemoveListener(Action response);
