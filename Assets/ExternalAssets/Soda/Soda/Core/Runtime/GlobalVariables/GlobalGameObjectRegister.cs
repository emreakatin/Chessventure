...
namespace ThirteenPixels.Soda
{
    ...
    public class GlobalGameObjectRegister : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("globalGameObject")]
        [SerializeField]
        ...
        public GlobalGameObject globalGameObject
        {
            ...
            set
            {
                ...
                if (_globalGameObject && enabled)
                {
                    _globalGameObject.onChange.RemoveListener(CheckValue);
                ...
                if (_globalGameObject && enabled)
                {
                    ...
                    if (couldSetValue)
                    {
                        _globalGameObject.onChange.AddListener(CheckValue);
                    }
                    else
                    {
                        enabled = false;
        ...
        private void OnEnable()
        {
            ...
            globalGameObject.onChange.AddListener(CheckValue);
        }
        ...
        private void OnDisable()
        {
            ...
            globalGameObject.onChange.RemoveListener(CheckValue);
