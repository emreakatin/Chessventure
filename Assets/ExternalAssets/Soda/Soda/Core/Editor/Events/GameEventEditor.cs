    ...
    public class GameEventEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (onRaiseGloballyProperty != null)
            {
                ...
                {
                    serializedObject.DisplayAllPropertiesExcept(false, descriptionProperty, debugProperty, onRaiseGloballyProperty, parameterDescriptionProperty);
                }
                else
                {
                    serializedObject.DisplayAllPropertiesExcept(false, descriptionProperty, debugProperty, onRaiseGloballyProperty);
                }
            }
            else
            {
                if (parameterDescriptionProperty != null)
                {
                    serializedObject.DisplayAllPropertiesExcept(false, descriptionProperty, debugProperty, parameterDescriptionProperty);
                }
                else
                {
                    serializedObject.DisplayAllPropertiesExcept(false, descriptionProperty, debugProperty);
                }
            }
